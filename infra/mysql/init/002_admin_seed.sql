...
INSERT INTO campus_event (
  ...
  (9101, '人工智能主题讲座通知', '软件学院将于 7 月 8 日举办 AI 主题讲座，面向软件学院本科生开放。', 'LECTURE', 'PUBLIC_WEB', 'AI_PUBLISHED', '2026-07-08 19:00:00', '2026-07-08 21:00:00', '图书馆报告厅', '软件学院', JSON_ARRAY('软件学院本科生'), JSON_ARRAY('AI','讲座','软件学院'), SHA2('9101-ai-lecture', 256), NULL, '2026-07-07 10:00:00', '2026-07-07 18:00:00'),
  (9102, '期末考试考场调整说明', '部分课程考试地点变更，学生需以最终考场清单为准。', 'EXAM', 'PUBLIC_WEB', 'CORRECTED', '2026-07-11 09:30:00', '2026-07-11 11:30:00', '一号教学楼', '教务处', JSON_ARRAY('2023级'), JSON_ARRAY('考试','教务'), SHA2('9102-exam-change', 256), 'event-vec-9102', '2026-07-07 09:30:00', '2026-07-07 17:56:00'),
  (9103, '雨课堂作业提交提醒', 'SE101 课程作业截止到 7 月 9 日 23:59，来源为用户粘贴 JSON。', 'HOMEWORK', 'RAIN_CLASSROOM', 'AI_PUBLISHED', '2026-07-09 23:59:00', NULL, '线上', 'SE101 课程组', JSON_ARRAY('SE101'), JSON_ARRAY('雨课堂','作业'), SHA2('9103-rain-homework', 256), NULL, '2026-07-07 09:00:00', '2026-07-07 17:40:00'),
  (9104, '创新创业竞赛报名开放', '创新创业竞赛进入报名阶段，材料提交窗口开放至 7 月 15 日。', 'COMPETITION', 'PUBLIC_WEB', 'REVIEWED', '2026-07-15 18:00:00', NULL, '学生事务中心', '学工系统', JSON_ARRAY('全校学生'), JSON_ARRAY('竞赛','报名'), SHA2('9104-competition', 256), 'event-vec-9104', '2026-07-07 08:40:00', '2026-07-07 17:25:00'),
  (9105, '暑期图书馆开放服务调整', '图书馆暑期开放时间调整，部分阅览区暂停夜间服务。', 'SERVICE', 'PUBLIC_WEB', 'AI_PUBLISHED', '2026-07-10 08:30:00', '2026-08-25 22:00:00', '图书馆', '图书馆', JSON_ARRAY('全校师生'), JSON_ARRAY('服务','图书馆'), SHA2('9105-library-service', 256), NULL, '2026-07-07 08:20:00', '2026-07-07 17:10:00'),
  (9106, '软件工程课程调课通知', '软件工程课程本周四调至二号教学楼 305，请相关班级注意。', 'COURSE', 'PUBLIC_WEB', 'CORRECTED', '2026-07-09 14:00:00', '2026-07-09 16:00:00', '二号教学楼 305', '软件工程课程组', JSON_ARRAY('软件工程1班'), JSON_ARRAY('课程','调课'), SHA2('9106-course-change', 256), NULL, '2026-07-07 08:10:00', '2026-07-07 16:50:00'),
  (9107, '社团嘉年华活动安排', '社团嘉年华将在操场举办，面向全校学生开放报名。', 'ACTIVITY', 'USER_IMAGE', 'AI_PUBLISHED', '2026-07-12 18:30:00', '2026-07-12 21:00:00', '东区操场', '校团委', JSON_ARRAY('全校学生'), JSON_ARRAY('社团','活动'), SHA2('9107-club-activity', 256), NULL, '2026-07-07 08:00:00', '2026-07-07 16:30:00'),
  (9108, '校园网络维护通知', '信息中心将进行校园网络维护，部分区域网络可能短时中断。', 'NOTICE', 'PUBLIC_WEB', 'REVIEWED', '2026-07-13 00:30:00', '2026-07-13 02:00:00', '全校网络', '信息中心', JSON_ARRAY('全校师生'), JSON_ARRAY('通知','网络'), SHA2('9108-network-notice', 256), 'event-vec-9108', '2026-07-07 07:50:00', '2026-07-07 16:10:00'),
  (9109, '旧通知重复截图', '用户上传的截图与历史通知重复，已标记为无效。', 'OTHER', 'USER_IMAGE', 'REJECTED', NULL, NULL, NULL, '用户导入', JSON_ARRAY(), JSON_ARRAY('重复','截图'), SHA2('9109-duplicate-image', 256), NULL, NULL, '2026-07-07 15:50:00'),
  (9110, '过期服务公告下线', '公告已过有效期，不再在信息流展示。', 'SERVICE', 'USER_TEXT', 'OFFLINE', '2026-06-20 08:00:00', NULL, '线上', '用户导入', JSON_ARRAY('全校师生'), JSON_ARRAY('过期','服务'), SHA2('9110-offline-service', 256), NULL, NULL, '2026-07-07 15:40:00');
