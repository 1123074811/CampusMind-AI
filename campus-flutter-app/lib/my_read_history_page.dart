...
class MyReadHistoryPage extends StatefulWidget {
  const MyReadHistoryPage({
    super.key,
    required this.api,
  ...
  @override
  State<MyReadHistoryPage> createState() => _MyReadHistoryPageState();
}

class _MyReadHistoryPageState extends State<MyReadHistoryPage> {
